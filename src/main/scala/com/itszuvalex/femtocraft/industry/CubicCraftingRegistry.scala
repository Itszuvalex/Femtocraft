...
object CubicCraftingRegistry extends Initializable {
  val recipeInputMap = new util.TreeMap[(Array[Array[ItemStack]], FluidStack), CubicCraftingRecipe](new Comparator[(Array[Array[ItemStack]], FluidStack)] {
  ...
  def findMatchingRecipe(input: (Array[Array[ItemStack]], FluidStack)) = recipeInputMap.get(input)
