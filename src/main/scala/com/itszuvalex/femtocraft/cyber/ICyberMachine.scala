...
trait ICyberMachine {
  ...
  def getTakenLocations(world: World, x: Int, y: Int, z: Int): Set[Loc4] = ICyberMachine.getTakenLocations(x, y, z, world.provider.dimensionId, getRequiredBaseSize, getRequiredSlots)
