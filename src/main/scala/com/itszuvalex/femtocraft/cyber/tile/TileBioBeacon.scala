...
import com.itszuvalex.femtocraft.cyber.machine.MachineBioBeacon
...
/**
  ...
  */
class TileBioBeacon extends TileEntityBase with CyberMachineMultiblock with TileMultiblockIndexedInventory with TileFluidTank {
  def onBlockBreak() = {}
  ...
  override def getCyberMachine = MachineBioBeacon.NAME
}
