...
import com.itszuvalex.femtocraft.cyber.machine.MachineCybermatDisintegrator
...
/**
  ...
  */
class TileCybermatDisintegrator extends TileEntityBase with CyberMachineMultiblock with TileMultiblockIndexedInventory with TileFluidTank {
  def onBlockBreak() = {}
  ...
  override def getCyberMachine = MachineCybermatDisintegrator.NAME
}
